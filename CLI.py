...
class CLI:
    ...
    def cliMenu(self):
        while True:
            ...
            print(
                ...
                if not self.__strIncrement == "Hourly"
                else "2) Set Pay Increment ({} ({} Hours))".format(
                    self.__strIncrement, self.__iHours
                )
            )
            print(
                "3) Set Tax Options (HECS/HELP: {}, No Tax Free Threshold: {}, Include Superannuation: {}, FY{})".format(
                    self.__dictOptions.get("bHECS"),
    ...
    def __setIncomeMenu(self):
        ...
        while not bIntValid:
            strTempIncome = input(
                "Enter Income for Time Period (${} {}): ".format(
    ...
    def __setPayIncrementMenu(self):
        ...
        while not self.__verifyPayInput(strInput):
            strInput = input("Enter Increment ({}): ".format(self.__strIncrement))
    ...
    def __setTaxOptionsMenu(self):
        while True:
            ...
            print(
                "2) No Tax Free Threshold ({})".format(self.__dictOptions.get("bNTFT"))
            )
            print(
                "3) Salary Include Superannuation ({})".format(
                    self.__dictOptions.get("bSuper")
                )
            )
            print("4) Set Finincal Year ({})".format(self.__dictOptions.get("iFY")))
            ...
            try:
                ...
                if iInput < 0 or iInput > 5:
                    ...
                    if iInput == 5:
                        ...
                        iFY = self.__setFYYearMenu()
                        self.__dictOptions.update({"iFY": iFY})
            except:
                print("Invalid Input!!")

    ## Menu to set FY
    def __setFYYearMenu(self) -> int:
        while True:
